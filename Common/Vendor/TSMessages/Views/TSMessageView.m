...
#define TSMessageViewMinHeight   64
  ...
  shouldBeDismissed:(BOOL)dismissAble
{
    ...
    if ((self = [self init]))
    {
        ...
        else
        {
            ...
            self.backgroundBlurView.blurTintColor = [UIColor themeBlueColor];
            [self addSubview:self.backgroundBlurView];
        }
        
        UIColor *fontColor = [UIColor whiteColor];//[UIColor colorWithHexString:[current valueForKey:@"textColor"]alpha:1.0];
        ...
        CGFloat fontSize = 15;//[[current valueForKey:@"titleFontSize"] floatValue];
...
//                                                    [[current valueForKey:@"shadowOffsetY"] floatValue])];
        ...
        self.frame = CGRectMake(0.0, 0/*topPosition*/, screenWidth, actualHeight);
...
//    [self.titleLabel sizeToFit];
    ...
    if (currentHeight < TSMessageViewMinHeight) {
        currentHeight = TSMessageViewMinHeight;
    }
